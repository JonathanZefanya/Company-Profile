                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            <div className="flex-shrink-0">
                                <a href="#" className="text-[#A3D8FF] font-bold text-base">HRMS</a>
                            </div>
                        </div>
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center space-x-8">
                                ...
                                <Link href={"/services"} className="text-white hover:bg-[#A3D8FF] hover:text-black-100 hover:px-3 hover:py-2 hover:rounded-lg transition-all duration-300 font-medium text-base">Service</Link>
                            </div>
                        </div>
