...
import { Feature, Experience, TechStack } from './SyntaxHihglighter';
            ...
            <ul className="flex flex-wrap font-medium text-sm text-white">
                <li className="me-2">
                    ...
                    <button className={ toggleState === 3 ? "inline-block px-7 py-2 hover:bg-[#A3D8FF] bg-[#A3D8FF] text-black-100 rounded-lg": "inline-block px-7 py-2 rounded-lg"} onClick={() => toggleTab(3)} >
                        <div className="flex flex-wrap">
                            <SiPython fill="#3776AB" className="w-5 h-5 mr-3" /> fitur.py
                        </div>
                    </button>
                    <button className={ toggleState === 4 ? "inline-block px-7 py-2 hover:bg-[#A3D8FF] bg-[#A3D8FF] text-black-100 rounded-lg": "inline-block px-7 py-2 rounded-lg"} onClick={() => toggleTab(4)} >
                        <div className="flex flex-wrap">
                            <SiAseprite fill="#7D929E" className="w-5 h-5 mr-3" /> my sosmed as developer
                        </div>
                    </button>
                </li>
            </ul>
